...
product1 = prod.set(input(), input())
basket1.container_selection(product1)
product2 = prod.set(input(), input())
basket1.container_selection(product1)
product3 = prod.set(input(), input())
basket1.container_selection(product3)
product4 = prod.set(input(), input())
basket1.container_selection(product)
